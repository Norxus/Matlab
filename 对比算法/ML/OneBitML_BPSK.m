...
errorNumber_f10 =0;
 ...
 M=2;
 X_S = [1,-1];
[x16,x15,x14,x13,x12,x11,x10,x9,x8,x7,x6,x5,x4,x3,x2,x1] = ndgrid(X_S,X_S,X_S,X_S,X_S,X_S,X_S,X_S,X_S,X_S,X_S,X_S,X_S,X_S,X_S,X_S);
 X_S_temp = [x16(:),x15(:),x14(:),x13(:),x12(:),x11(:),x10(:),x9(:),x8(:),x7(:),x6(:),x5(:),x4(:),x3(:),x2(:),x1(:)]';
 X_ML = X_S_temp;
